...
const Dashboard: React.FC = () => {
  return (
    <div className="w-full min-h-screen relative overflow-hidden bg-gradient-to-br from-blue-800 to-blue-500 font-sans">
      ...
      <div className="relative px-2 py-2 sm:px-4 sm:py-4 w-full h-auto flex flex-col lg:flex-row gap-3 sm:gap-4 lg:gap-5 z-[2] lg:absolute lg:left-[28px] lg:top-[92px] lg:max-w-[1408px] lg:h-[1268px]">
        
        {/* Sidebar */}
        <div className="w-full lg:w-[360px] lg:h-[1268px] relative flex-shrink-0 order-2 lg:order-1">
        ...
        <div className="flex-1 relative order-1 lg:order-2">
          ...
          <div className="w-full h-auto lg:h-[140px] bg-gradient-to-b from-white/98 to-slate-50/98 border border-black/6 rounded-xl lg:rounded-[18px] p-3 sm:p-4 lg:p-5 mb-3 lg:mb-[14px]">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start gap-4">
              ...
              {/* Metric Cards */}
              <div className="flex gap-2 sm:gap-3 lg:gap-4 w-full lg:w-auto justify-center lg:justify-end mt-3 lg:mt-0">
      ...
      {/* Footer */}
      <div className="absolute left-1/2 transform -translate-x-1/2 bottom-8 text-white/85 text-xs text-center lg:left-[575px] lg:top-[1368px] lg:w-[290px] lg:transform-none lg:bottom-auto">
